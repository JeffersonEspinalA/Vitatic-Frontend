...
@NgModule({
  declarations: [AppComponent, HomeComponent, ScheduleComponent, AdvicesectionComponent, InstructionComponent, ListactivitiesComponent, ProgressComponent, EstadisticsComponent],
